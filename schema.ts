...
// Import the .env file in the root exposing the needed ENVIRONMENT VARIABLES
// Accessible through process.env.ENVIRONMENT_VARIABLE
...
export const lists: Lists = {
  Image: list({
    fields: {
        name: text(),
        image: azureStorageImage({azureStorageConfig: azureStorageConfig }),
  ...
  Post: list({
    fields: {     
      ...
      image: azureStorageImage({ azureStorageConfig: azureStorageConfig }),
      file: azureStorageFile({ azureStorageConfig: azureStorageConfig }),
